...
export default function LoudnessLab() {
    ...
    return (
        ...
        <label className={`px-6 py-3 rounded-lg cursor-pointer font-semibold text-sm relative ${theme.btn} ${theme.btnHover}`}>
        Choose Audio File
        <input 
        type="file" 
        accept="audio/*" 
        ...
        {analysis && (
            ...
            <label className={`self-end text-xs cursor-pointer relative ${theme.textAccent}`}>
            Upload New Track
            <input 
            type="file" 
            accept="audio/*" 
            ...
            <p className="text-xs text-center mt-1 opacity-70">Click / hover to seek & inspect</p>
            </div>
